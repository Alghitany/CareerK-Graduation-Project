  ...
  Widget build(BuildContext context) {
    return Form(
      ...
      children: [
        ...
        verticalSpace(8),
        AppTextFormField(
            controller: context.read<DeveloperSignupCubit>().currentTrackController,
        ...
        verticalSpace(8),
        AppTextFormField(
            controller: context.read<DeveloperSignupCubit>().trackLevelController,
            hintText: 'Senior',
            validator: (level) {
        ...
        verticalSpace(8),
        AppTextFormField(
            controller: context.read<DeveloperSignupCubit>().previousJobController,
        ...
        verticalSpace(8),
        AppDropDownMenu(
          controller: context.read<DeveloperSignupCubit>().typeOfJobController,
          hintText: 'Remote',
        ...
        verticalSpace(8),
        AppTextFormField(
          controller: context.read<DeveloperSignupCubit>().yearsOfExperienceController,
          hintText: '2',
        ...
        verticalSpace(8),
        AppTextFormField(
            controller: context.read<DeveloperSignupCubit>().expectedSalaryController,
            hintText: '12000 EGP',
            validator: (salary) {
