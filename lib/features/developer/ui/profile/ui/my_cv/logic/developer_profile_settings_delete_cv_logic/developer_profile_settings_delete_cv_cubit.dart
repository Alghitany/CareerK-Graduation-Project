...
class DeveloperProfileSettingsDeleteCVCubit extends Cubit<DeveloperProfileSettingsDeleteCVState> {
  ...
  Future<void> deleteCV(DeveloperProfileSettingsDeleteCVRequestBody body) async {
