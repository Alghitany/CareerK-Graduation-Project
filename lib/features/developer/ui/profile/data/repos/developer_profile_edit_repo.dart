...
import '../models/developer_profile_edit_request_body.dart';
import '../models/developer_profile_edit_response.dart';

class DeveloperProfileEditRepo {
  final Dio _dio;

  DeveloperProfileEditRepo(this._dio);

  Future<ApiResult<DeveloperProfileEditResponse>> editDeveloperProfile({
    required DeveloperProfileEditRequestBody body,
    String? cvFilePath,
    ...
    try {
      ...
      final response = await _dio.patch(
        "${ApiConstants.apiBaseUrl}${ApiConstants.developerProfileEdit}",
        data: formData,
        options: Options(headers: {'Content-Type': 'multipart/form-data'}),
      );

      final developerProfileEditResponse =
