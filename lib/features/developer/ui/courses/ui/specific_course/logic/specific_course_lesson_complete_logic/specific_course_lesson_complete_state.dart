...
@freezed
class SpecificCourseLessonCompleteState
    with _$SpecificCourseLessonCompleteState {
  const factory SpecificCourseLessonCompleteState.initial() = _Initial;

  const factory SpecificCourseLessonCompleteState.loading() =
      SpecificCourseLessonCompleteLoading;
