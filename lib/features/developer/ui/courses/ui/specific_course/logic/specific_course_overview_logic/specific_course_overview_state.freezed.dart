...
class _$SpecificCourseOverviewErrorImpl implements SpecificCourseOverviewError {
  const _$SpecificCourseOverviewErrorImpl(this.apiErrorModel);
  ...
  @override
  String toString() {
    return 'SpecificCourseOverviewState.error(apiErrorModel: $apiErrorModel)';
  }
...
abstract class SpecificCourseOverviewError
    implements SpecificCourseOverviewState {
  const factory SpecificCourseOverviewError(final ApiErrorModel apiErrorModel) =
      _$SpecificCourseOverviewErrorImpl;
