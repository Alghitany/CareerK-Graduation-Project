  ...
  final List<Map<String, dynamic>> jobs = [
    {
      ...
      'postDate': '6 days ago',
      'budget': 200,
      'description': 'Design a user interface for an all-encompassing freelance gig platform app. This app should enable freelancers to sell various services, feat...',
                  ...
                  Text.rich(
                    TextSpan(
                      children: [
                        ...
                        TextSpan(
                          text: '${job['budget']}\$',
                          style: AppTextStyles.font14RangoonGreenRalewayMedium, // e.g. stronger style
                        ),
                      ],
                    ),
                  ),
