...
part of 'conact_list_all_chats_response_body.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ContactListAllChatsResponseBody _$ContactListAllChatsResponseBodyFromJson(
        Map<String, dynamic> json) =>
    ContactListAllChatsResponseBody(
      chats: (json['chats'] as List<dynamic>)
          .map((e) => ChatItem.fromJson(e as Map<String, dynamic>))
          .toList(),
    );

Map<String, dynamic> _$ContactListAllChatsResponseBodyToJson(
        ContactListAllChatsResponseBody instance) =>
    <String, dynamic>{
