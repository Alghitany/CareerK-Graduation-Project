...
part of 'company_jobs_post_response.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

CompanyJobsPostResponse _$CompanyJobsPostResponseFromJson(
        Map<String, dynamic> json) =>
    CompanyJobsPostResponse(
      message: json['message'] as String?,
      job: json['job'] == null
          ? null
          : JobData.fromJson(json['job'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$CompanyJobsPostResponseToJson(
        CompanyJobsPostResponse instance) =>
    <String, dynamic>{
