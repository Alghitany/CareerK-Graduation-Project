...
class _ApiService implements ApiService {
  ...
  @override
  Future<DeveloperCoursesSpecificCourseResponseBody> getCourseHeader(
    ...
    const Map<String, dynamic>? _data = null;
    final _options =
        _setStreamType<DeveloperCoursesSpecificCourseResponseBody>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late DeveloperCoursesSpecificCourseResponseBody _value;
    try {
      _value =
          DeveloperCoursesSpecificCourseResponseBody.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
